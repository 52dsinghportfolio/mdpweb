                                    ...
                                    <div className="collapse navbar-collapse" id="mobileMenu_block">
                                        <div className="navbar_itemblock">
                                                                ...
                                                                <Row>
                                                                        ...
                                                                        <div className='it_menucard_block'>
                                                                            ...
                                                                            <div className='it_menucard_body'>
                                                                                <ul className="it_megamenunew">
                                                                                    ...
                                                                                    <li className="menu-item">
                                                                                        <NavLink className="menu-link" to="civil/ertificates">
                                                                                            Civil Certificates
                                                                                        </NavLink>
                                                                                    </li>
                                                                                    <li className="menu-item">
                                                                                        <NavLink className="menu-link" to="civil/contactus">
                                                                                            Civil Contact Us
                                                                                        </NavLink>
                                                                                    </li>
                                                                                </ul>
                                                                    ...
                                                                    <Col lg="3" md="4" sm="12">
                                                                        <div className='it_menucard_block'>
                                                                            <div className='it_menucard_header'>
                                                                                <h4>
                                                                                    Commercial & Residential Fit-Out
                                                                                </h4>
                                                                            </div>
                                                                            <div className='it_menucard_body'>
                                                                                <ul className="it_megamenunew">
                                            ...
                                            {activeMenu === "civil" && (
                                                <ul className="navbar-nav">
                                                    <li className="nav-item">
                                                        <NavLink className="nav-link" to="/civil/home">
                                                            Home
                                                        </NavLink>
                                                    </li>
                                                    <li className="nav-item">
                                            ...
                                            {activeMenu === "electrical" && (
                                                <ul className="navbar-nav">
                                                    <li className="nav-item">
                                                        <NavLink className="nav-link" to="/electrical/home">
                                                            electrical Home
                                                        </NavLink>
                                                    </li>
                                                    <li className="nav-item">
                                                        <NavLink className="nav-link" to="/electrical/aboutus">
                                                            electrical About Us
                                                        </NavLink>
                                                    </li>
                                                </ul>
